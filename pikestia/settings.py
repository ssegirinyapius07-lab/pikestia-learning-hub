...
ACCOUNT_SIGNUP_FORM_CLASS = 'apps.accounts.forms.SignupExtraForm'
...
# SMTP settings are read from environment variables so credentials stay out
# of source control. The console backend remains the safe local default.
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "noreply@pikestia.com")\nCONTACT_EMAIL = os.getenv("CONTACT_EMAIL", "support@pikestia.com")
